...
let output = fs.readFileSync(outputPath)
const startMarker = '<!-- AUTOGENERATED - DO NOT EDIT - START -->\n'
const endMarker = '<!-- AUTOGENERATED - DO NOT EDIT - END -->\n'
const startIndex = output.indexOf(startMarker)
const endIndex = output.indexOf(endMarker) + endMarker.length
const postChunk = output.slice(endIndex)
...
suite.on('start', function () {
  output += startMarker
  output += '| Method | Secure | Format | Re-use | Cache | Sync | Ops/sec | RME | Samples |\n'
  output += '|--------|--------|--------|--------|-------|------|---------|-----|---------|\n'
})
...
suite.on('cycle', function (event) {
  ...
  output += `| [${t.name}] | ${bool(t.secure)} | ${t.format} | ${bool(t.reuse)} | ${t.cacheSize || 'n/a'} | ${bool(!t.defer)} | ${numeral(t.hz).format('0,0')} | ±${t.stats.rme.toFixed(2)}% | ${t.stats.sample.length} |\n`
})
